...
import image1 from '../../public/assets/images/auth/coming-soon-object1.png';
import image2 from '../../public/assets/images/auth/coming-soon-object2.png';
import image3 from '../../public/assets/images/auth/coming-soon-object3.png';
import image4 from '../../public/assets/images/auth/polygon-object.svg';
import image5 from '../../public/assets/images/auth/bg-gradient.png';
...
const LoginBoxed = () => {
  ...
  useEffect(() => {
    const code = localStorage.getItem('i18nextLng') || themeConfig.locale;
    setLocale(code);
  ...
  return (
    <div>
      <div className="absolute inset-0">
        <Image src={image5} alt="image" className="h-full w-full object-cover" />
      </div>

      <div className="relative flex min-h-screen items-center justify-center bg-[url(/assets/images/auth/map.png)] bg-cover bg-center bg-no-repeat px-6 py-10 dark:bg-[#060818] sm:px-16">
        <Image src={image1} alt="image" className="absolute left-0 top-1/2 h-full max-h-[893px] -translate-y-1/2" />
        <Image src={image2} alt="image" className="absolute left-0 top-1/2 h-full max-h-[893px] -translate-y-1/2" />
        <Image src={image2} alt="image" className="absolute left-24 top-0 h-40 md:left-[30%]" />
        <Image src={image3} alt="image" className="absolute right-0 top-0 h-[300px]" />
        <Image src={image4} alt="image" className="absolute bottom-0 end-[28%]" />
                ...
                {flag && (
                  <Dropdown
                    ...
                    button={
                      <>
                        <div>
                          <Image height={20} width={20} src={`/assets/images/flags/${flag.toUpperCase()}.svg`} alt="image" className="h-5 w-5 rounded-full object-cover" />
                        </div>
                      ...
                      {themeConfig.languageList.map((item: any) => {
                        return (
                          <li key={item.code}>
                            ...
                            >
                              <Image height={20} width={20} src={`/assets/images/flags/${item.code.toUpperCase()}.svg`} alt="flag" className="h-5 w-5 rounded-full object-cover" />
              ...
              <form className="space-y-5 dark:text-white" onSubmit={submitForm}>
                <div>
                  ...
                  <div className="relative text-white-dark">
                    <input id="Email" type="email" placeholder="Enter Email" ref={emailRef} className="form-input ps-10 placeholder:text-white-dark" />
                ...
                <div>
                  ...
                  <div className="relative text-white-dark">
                    <input id="Password" type="password" placeholder="Enter Password" ref={passwordRef} className="form-input ps-10 placeholder:text-white-dark" />
                    <span className="absolute start-4 top-1/2 -translate-y-1/2">
                      <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                        <path
                          opacity="0.5"
